...
class WorldModel(BaseWorldModel):
    ...
    def __init__(self, config, obs_space, act_space, step, enable_fp16 = False):
        ...
        self.rssm = nets.EnsembleRSSM(action_dim=act_space['action'].shape[0],**config.rssm,concat_embed = self.config.concat_embed)
        ...
        self.contextualized = self.config.decoder_type == 'deco_resnet'
